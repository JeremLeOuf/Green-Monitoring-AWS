...
=======
        ...
        region = event['region']
>>>>>>> parent of 7d5f051 (Update lambda for FE clarity)
...
=======
        ...
        estimated_co2e = kWh * carbon_intensity
>>>>>>> parent of 7d5f051 (Update lambda for FE clarity)
        ...
        avg_watt_hours_data = [
            ...
            {'Metric': f'Power consumption (kWh) for {period_label}:', 'Value': f'{kWh:.2f} kWh'}
        ]
        carbon_intensity_data = [
            {'Metric': 'Carbon Intensity (gCO2e/kWh):', 'Value': f'{carbon_intensity:.0f} gCO2e/kWh'}
        ]
        co2e_emissions_data = [
<<<<<<< HEAD
...
=======
            {'Metric': 'Estimated CO2e Emissions:', 'Value': f'{estimated_co2e:.2f} gCO2e'}
>>>>>>> parent of 7d5f051 (Update lambda for FE clarity)
        ]
...
=======
            f"Your {instance_type} instance with an average {vcpu_utilization:.0f}% CPU Utilization over a period of {period_label} would generate an average of {avg_watts:.2f} Watts (W), consuming a total of <b>{kWh:.2f} Kilowatt-Hours (kWh)</b> over that period.<br><br>The carbon intensity for your region is {carbon_intensity:.2f} gCO2/kWh (as of **TODO**)."]
>>>>>>> parent of 7d5f051 (Update lambda for FE clarity)
